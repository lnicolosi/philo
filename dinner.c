...
/*
	...
	1) grab de forks : here first & second fork is handy
		i dont worry about left or right
...
/*
	0) wait all philos, syncro start
...
void	*dinner_simulation(void *data)
{
	...
	// syncro with monitor
	// increase a table variable counter. with all thread running
